...
export const updateContact = async (payload) => {
  return axios.post(`/admin/office`, payload).then((response) => response.data);
};

export const getContact = async () => {
  return axios.get(`/admin/offices`).then((response) => response.data?.data);
};
...
export const getAbout = async () => {
  return axios.get(`/admin/abouts`).then((response) => response?.data?.data);
};

//service page
export const updateService = async (payload) => {
  return axios
    .post(`/admin/addOrUpdateService`, payload)
    .then((response) => response?.data);
};

export const getService = async () => {
  return axios.get(`/admin/services`).then((response) => response?.data?.data);
};
